...
class FullTimeEmp {
    ...
    public String createPayStub() {
        ...
        return "\n\t\tHEARTLAND CARS OF AMERICA"
                + "\n\n\t" + firstName + " " + lastName
                + "\n\n\tBasic Salary \t$" + df.format(baseSalary)
                + "\n\tHours Worked \t" + hoursWorked
                + "\n\tPay \t\t$" + df.format(salary)
                + "\n";
    }

    public void setFirstName(String s) { firstName = s; }
    public void setLastName(String s) { lastName = s; }
    public void setBaseSalary(double d) { baseSalary = d; }
    public void setHoursWorked(int i) { hoursWorked = i; }
}
...
class PartTimeEmp {
    ...
    public String createPayStub() {
        ...
        return "\n\t\tHEARTLAND CARS OF AMERICA"
                + "\n\n\t" + firstName + " " + lastName
                + "\n\n\tSalary/Hour \t$" + df.format(payPerHour)
                + "\n\tHours Worked \t" + hoursWorked
                + "\n\tPay \t\t$" + df.format(salary)
                + "\n";
    }
    ...
    public void setFirstName(String s) { firstName = s; }
    public void setLastName(String s) { lastName = s; }
    public void setPayPerHour(double d) { payPerHour = d; }
    public void setHoursWorked(int i) { hoursWorked = i; }
}
...
class SalesEmp {
    ...
    public String createPayStub() {
        ...
        return "\n\t\tHEARTLAND CARS OF AMERICA"
                + "\n\n\t" + firstName + " " + lastName
                + "\n\n\tBasic Salary \t$" + df.format(baseSalary)
                + "\n\tSales Volume \t$" + df.format(salesVolume)
                + "\n\tPay \t\t$" + df.format(salary)
                + "\n";
    }
    ...
    public void setLastName(String s) { lastName = s; }
    public void setBaseSalary(double d) { baseSalary = d; }
    public void setSalesVolume(double d) { salesVolume = d; }
}
